...
with tab2:
    ...
    dataset_sorted = inkomen.sort_values(by='Mean')

    # Bepaal de drempelwaarden voor de inkomensgroepen
    n = len(dataset_sorted)
    income_threshold_low = int(0.33 * n)
    income_threshold_high = int(0.66 * n)
...
with tab2:
    ...
    st.write("Hieronder is de verdeling van het huishoudinkomen opgedeeld in inkomensgroepen over de staat te zien. "
             "Een laag inkomen is een inkomen onder 40.000 dollar, een gemiddeld inkomen is een inkomen tussen de 40.000 dollar en 100.000 dollar en een hoog inkomen is een inkomen boven de 100.000 dollar. "
